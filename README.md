...
Fedora 24 users, must fix an issue related with libncurses. Avrdude installed with PlatformIO relies on a different version of linbsurses. To fix this issue, execute this steps after you finish creating your first project (running platformio init for the first time). 
